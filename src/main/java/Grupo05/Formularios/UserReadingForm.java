...
public class UserReadingForm extends JDialog {
    ...
    public UserReadingForm(MainForm mainForm) {
        ...
        txtName.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (!txtName.getText().trim().isEmpty()) {
                    ...
                    tblUsuarios.setModel(emptyModel);
                }
            }
        });
        ...
        btnCrear.addActionListener(s -> {
            ...
            UserForm userForm = new UserForm(this.mainForm, CUD.CREATE, new User());
        ...
        btnEditar.addActionListener(s -> {
            ...
            if (user != null) {
                ...
                UserForm userForm = new UserForm(this.mainForm, CUD.UPDATE, user);
                // Hace visible el formulario de escritura de usuario.
                userForm.setVisible(true);
        ...
        btnEliminar.addActionListener(s -> {
            ...
            if (user != null) {
                ...
                UserForm userForm = new UserForm(this.mainForm, CUD.DELETE, user);
                // Hace visible el formulario de escritura de usuario.
                userForm.setVisible(true);
    ...
    public void createTable(ArrayList<User> users) {
        ...
        for (int i = 0; i < users.size(); i++) {
            ...
            model.setValueAt(user.getFechaCreado(), i, 2);
    ...
    private void hideCol(int pColumna) {
        ...
        this.tblUsuarios.getColumnModel().getColumn(pColumna).setMaxWidth(0);
        ...
        this.tblUsuarios.getColumnModel().getColumn(pColumna).setMinWidth(0);
        ...
        this.tblUsuarios.getTableHeader().getColumnModel().getColumn(pColumna).setMaxWidth(0);
        this.tblUsuarios.getTableHeader().getColumnModel().getColumn(pColumna).setMinWidth(0);
    }
    ...
    private User getUserFromTableRow() {
        ...
        try {
            ...
            int filaSelect = this.tblUsuarios.getSelectedRow();
            ...
            if (filaSelect != -1) {
                ...
                id = (int) this.tblUsuarios.getValueAt(filaSelect, 0);
            } else {
