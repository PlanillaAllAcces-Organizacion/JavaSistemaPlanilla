...
public class LoginForm extends JDialog {
    ...
    public void init(){
        ...
        topPanel.add(lblContra);
        topPanel.add(txtContraseña);
    ...
    private void login() {
        try{
            ...
            user.setName(txtUsuario.getText()); // Obtiene el texto ingresado en el campo de texto 'txtEmail'  y lo establece como el correo electrónico del objeto 'user'.
            user.setPasswordHash(new String(txtContraseña.getPassword())); // Obtiene la contraseña ingresada en el campo de contraseña 'txtPassword' (como un array de caracteres), la convierte a un String y la establece como la contraseña hasheada del objeto 'user'.
            ...
            if(userAut != null && userAut.getId() > 0 && userAut.getName().equals((user.getName()))){
